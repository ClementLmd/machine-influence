...
import { MapPin, Calendar, Euro, X, User, ArrowLeft } from "lucide-react";
...
async function getAnnouncement(id: string): Promise<AnnouncementWithRecruiter | null> {
  ...
  const res = await fetch(`${apiBaseUrl}/announcements/${id}`, {
    cache: "no-store",
  });
              ...
              <div className="flex items-center gap-2">
                {announcement.isPaid ? (
                  ...
                  <>
                    ...
                    <span className="text-muted-foreground">Non rémunéré</span>
                  </>
                )}
              </div>
            </div>
